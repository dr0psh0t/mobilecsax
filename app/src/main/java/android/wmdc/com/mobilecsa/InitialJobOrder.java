...
public class InitialJobOrder extends Fragment {
    ...
    private Button btnPhoto, btnPhotoPrev, btnSign, btnSignPrev, btnSubmit, mClear, mGetSign,
            btnCheckJo, mCancel;
    ...
    RecyclerView recyclerViewEngine, recyclerViewCustomer;
    ...
    private View.OnClickListener engineModelClickListener = new View.OnClickListener() {
        public void onClick(View view) {
            ...
            editTextSearchEngine.setFilters(new InputFilter[] {
    ...
    private View.OnClickListener customerClickListener = new View.OnClickListener() {
        public void onClick(View view) {
            ...
            editTextSearchCustomer.setFilters(new InputFilter[] {
                            new EmojiExcludeFilter(),
                            new InputFilter.LengthFilter(16)
                    }
            );
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btnCheckJo = v.findViewById(R.id.btnCheckJo);
        btnCheckJo.setOnClickListener(checkJoListener);

        return v;
    }

    private View.OnClickListener checkJoListener = new View.OnClickListener() {
        public void onClick(View view) {
    ...
    private DatePickerDialog.OnDateSetListener datePOListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
            etPODate.setText(new StringBuilder().append(year).append("-").append(month+1).append("-").append(dayOfMonth));
        }
    };

    private DatePickerDialog.OnDateSetListener dateDRListener = new DatePickerDialog.OnDateSetListener() {
        @Override
        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
    ...
    private void newQuotation() {
        try {
            ...
            // uncomment if refno and jonum values are required to be the same
            if (!joNumber.equals(refNo)) {
                Toast.makeText(getActivity(), "Reference number should be the same with jo number.",
    ...
    private class NewQuotationTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String[] paramss) {
            try {
                url = new URL(sharedPreferences.getString("domain", null)+"initialjoborder");
    ...
    private class CheckInitial extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog = new ProgressDialog(getActivity());
        HttpURLConnection conn = null;
        URL url = null;
        ...
        protected String doInBackground(String[] params) {
            try {
                url = new URL(sharedPreferences.getString("domain", null)+"checkinitial");
                conn = (HttpURLConnection) url.openConnection();
                ...
                Uri.Builder builder = new Uri.Builder().appendQueryParameter("jono", params[0]);
