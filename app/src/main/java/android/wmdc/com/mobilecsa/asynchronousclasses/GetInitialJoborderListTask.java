...
public class GetInitialJoborderListTask extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String[] params) {
        try {
            ...
            Uri.Builder builder = new Uri.Builder().appendQueryParameter("csaId", params[0]);
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            if (jsonObject.getBoolean("success")) {
                InitialJoborderList initialJoborderListFragment = new InitialJoborderList();
                Bundle bundle = new Bundle();
                bundle.putString("initialJoResult", jsonObject.toString());
