...
public class AddCustomerFragment extends Fragment {
        ...
        etDateCust.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getActivity() != null) {
                    ...
                    Util.alertBox(getContext(), "Date error");
                ...
                if (spinIndCust.getSelectedItem() == null) {
                    ...
                    if (getFragmentManager() != null) {
                        ...
                        Util.alertBox(getActivity(), "Connection was not established." +
                                ...
                                "\nCheck server availability.", "Resource are empty", false);
                    } else {
                        Util.longToast(getActivity(), "Industry error.");
    ...
    private final AdapterView.OnItemSelectedListener spinnerFaxCountryCodeListener =
            new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> parent, View view, int position,
                                           long id) {
    ...
    private final AdapterView.OnItemSelectedListener spinnerCountryCodeListener =
            new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
                {
